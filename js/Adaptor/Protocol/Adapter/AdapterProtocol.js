...
async function ReadAdapterProtocolVersion() {
    let cmd = [];
...
async function ReadHardwareRevision() {
    let cmd = [];
...
async function WriteInfo(mdlId, hwRevMaj, hwRevMin) {
    let cmd = [];
...
async function SendKeySignature() {
    let cmd = [];
...
async function SendByte(dataByte) {
    let cmd = [];
...
async function SendData(data) {
    data.forEach(dataByte => SendByte(dataByte));
}